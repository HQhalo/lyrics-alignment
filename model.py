...
class AlignerModel(ModelPT):
    ...
    def __init__(self, cfg: DictConfig, trainer: 'Trainer' = None):
        ...
        jasper_encoder = instantiate(cfg.jasper_encoder)
        self.alignment_encoder = instantiate(cfg.alignment_encoder, jasper_encoder)
    ...
    def _metrics(self, attn_soft, attn_logprob, spec_len, text_len):
        ...
        if self.add_bin_loss:
            ...
            loss += self.bin_loss_scale * bin_loss
    ...
    def on_train_epoch_start(self):
        ...
        if self.add_bin_loss:
            self.bin_loss_scale = min((self.current_epoch - bin_loss_start_epoch + 1) / self.bin_loss_warmup_epochs, 1.0)
